...
public class GridLaser : GridObject
{
    ...
    [SerializeField] private Color _activeColor = Color.red; // couleur du laser activ�
    [SerializeField] private Color _inactiveColor = Color.gray; // couleur du laser d�sactiv�
